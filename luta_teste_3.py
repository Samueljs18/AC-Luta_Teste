...
class Lutador():
    ...
    def __init__(self,nome='lutador genérico',vida_max=100):
        self.vida_max = vida_max
        self.vida = vida_max
        self.nome = nome
        self.armas = {}
...
class Barbaro():
    ...
    def __init__(self,nome='lutador genérico',vida_max=200):
        self.vida_max = vida_max
        self.vida = vida_max
        self.nome = nome
        self.armas = {}
    ...
    def atacar(self):
        if self.envenenamento == False:
            self.vida -= 0

        if self.arma == 'bola de fogo':
            self.vida -= 20
                        
        dano = self.armas[self.arma].copy()
        if self.vida != self.vida_max:
            dano['valor'] = 2*dano['valor']
